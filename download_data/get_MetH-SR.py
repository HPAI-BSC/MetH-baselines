...
csv_url = "https://storage.hpai.bsc.es/datasets/raw/MetH-datasets/MetH-SR.csv"
data_url = "https://storage.hpai.bsc.es/datasets/raw/MetH-datasets/MetH-SR_data.tar.gz"
dataset_paths = Paths.MetHSR
